    ...
    <>
        ...
        relative'>
            ...
            <TitleSection title='Keep track of your meetings all in one place'
                subheading='Capture your ideas, thoughts, and meeting notes in a structured and organizer manner'
                ...
                cardHeader={
                    ...
                    >
                        ...
                        <div>
                            ...
                            <CardDescription className='drak:text-washed-purple-800'>
            ...
            '>
                {PRICING_CARDS.map((card) => (
                    ...
                    <CardContent className='p=0' >
                        ...
                        {+card.price > 0 ? (
                            <span className='dark:text-washed-purple-800
                            ml-1'>
                                /mo
                            </span>
                        ):('')}
